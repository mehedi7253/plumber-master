...
//                                }
                                    ...
                                    if($fname && $lname  && $contact && $address && $gender) {
                                        $user_exists = users_exists_by_id($_SESSION['c_id'], $username);
                                        if($user_exists === TRUE) {
                                            echo "username already exists <br /> ";
                                        } else {
                                            if(updateInfo($_SESSION['c_id']) === TRUE) {
                            ...
                            <div class="card-footer">
                                <a href="customer_dasboard.php" class="float-right"><button type="button" class="btn btn-info">Back</button></a>
                            </div>
                        </div>
                    </div>
                </div>
