                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="text-center font-weight-bold">Booking List</h2>
                            </div>
                            <div class="card-body">
                                        ...
                                        while ($fetch = mysqli_fetch_assoc($fetchs)){?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if (($status) == '1'){?>
                                                        <a href="rechived.php?status=<?php echo $fetch['id'];?>"><button class="btn btn-success">Received</button></a>
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    if (($status) == '0'){?>
                                                        <a href="pending.php?pending=<?php echo $fetch['id'];?>"><button class="btn btn-danger">Pending</button></a>
                                                        <?php
                                                    }
                                                    if (($status) == '1'){?>
                                                        <a href="pending.php?pending=<?php echo $fetch['id'];?>"><button class="btn btn-success">On Going</button></a>
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    if (($status) == '0'){?>
                                                        <a href="final_round.php?final_round=<?php echo $fetch['id'];?>"><button class="btn btn-danger">Pending</button></a>
                                                        <?php
                                                    }
                                                    if (($status) == '1'){?>
                                                        <a href="final_round.php?final_round=<?php echo $fetch['id'];?>"><button class="btn btn-info"> Process Going On</button></a>
                                                        <?php
                                                    }
                                                    if (($status) == '2'){?>
                                                        <a href="final_round.php?final_round=<?php echo $fetch['id'];?>"><button class="btn btn-success">Complete</button></a>
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
