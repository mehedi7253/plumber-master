                ...
                <div class="col-md-11 mx-auto mt-5">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="text-center">Confirm Plumber Location</h1>
                        </div>
                        <div class="card-body">
...
<?php
include_once '../php/locations_model.php';
?>
...
<script>
    ...
    function initMap() {
        var france = {lat: 23.777176, lng: 90.399452};
    ...
    function saveData() {
        ...
        var url = '../php/locations_model.php?confirm_location&id=' + id + '&confirmed=' + confirmed ;
