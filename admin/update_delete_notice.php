...
if ($_POST) {
    ...
    $sql = "UPDATE notice SET title = '$title', application = '$description' WHERE id = $id";
                            ...
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" placeholder="Enter Event Titile.." hidden value="<?php echo $data['id'];?>" class="form-control">
